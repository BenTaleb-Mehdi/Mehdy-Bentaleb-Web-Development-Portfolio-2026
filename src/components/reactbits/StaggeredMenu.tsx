...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope ${isFixed ? 'fixed top-0 left-0 w-screen h-screen overflow-hidden z-50 pointer-events-none' : 'w-full h-full'}`}
    >
      <div
        className={
...
.sm-scope .sm-logo-text { color: white; transition: color 0.3s ease; }
.sm-scope .staggered-menu-wrapper[data-open] .sm-logo-text { color: black; }
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(280px, 38vw, 420px); height: 100%; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
...
@media (max-width: 1024px) {
  ...
  .sm-scope .sm-panel-item { font-size: 3rem; letter-spacing: -1px; }
}
@media (max-width: 640px) {
  .sm-scope .staggered-menu-header { padding: 1.5em; }
  .sm-scope .staggered-menu-panel { padding: 5em 1.5em 1.5em 1.5em; }
  .sm-scope .sm-panel-item { font-size: 2.5rem; letter-spacing: -1px; padding-right: 1.2em; }
  .sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { font-size: 14px; right: 2.8em; }
