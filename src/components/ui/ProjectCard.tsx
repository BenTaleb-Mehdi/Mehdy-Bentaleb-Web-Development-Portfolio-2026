...
export function ProjectCard({ 
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-background/20 group-hover:bg-background/60 transition-colors duration-500 z-10" />
      <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/20 to-transparent opacity-70 group-hover:opacity-90 transition-opacity duration-500 z-10" />
      ...
      <div className="absolute top-8 left-8 right-8 z-30 flex flex-col gap-4 opacity-0 group-hover:opacity-100 transition-all duration-500 -translate-y-4 group-hover:translate-y-0">
        {description && (
          <p className="text-sm text-foreground font-light leading-relaxed max-w-[90%] drop-shadow-lg">
            {description}
          </p>
        )}
      ...
      <div className="relative z-30 transition-all duration-500 group-hover:-translate-y-2">
        <div className="flex justify-between items-start mb-4">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground font-medium translate-y-2 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500 drop-shadow-sm">{type}</p>
          </div>
        </div>
        ...
        <div className="flex items-center text-[0.65rem] font-mono tracking-[0.2em] text-muted-foreground group-hover:text-brand-green transition-colors duration-500 drop-shadow-md">
