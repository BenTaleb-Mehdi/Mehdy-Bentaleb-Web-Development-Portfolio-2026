...
export default function Hero({ onTriggerTerminal }: HeroProps) {
  ...
  return (
    <section className="flex flex-col items-center lg:items-start space-y-6 py-6 lg:py-0 p-2">
      <FloatingCard delay={0} className="w-full p-3 relative overflow-visible !bg-transparent !border-none !shadow-none" weight="heavy">
